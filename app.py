...
def generate_stars(num_stars=55):
    """Genera dinamicamente le stelle con posizioni e animazioni casuali."""
    colors = [
        "#f5c2e7",
        "#89dceb",
        "#cba6f7",
    ...
    for _ in range(num_stars):
        ...
        stars_svg += f'<circle class="star" cx="{cx}" cy="{cy}" r="{r}" fill="{color}" style="animation: {anim_name} {duration}s infinite ease-in-out {delay}s;" />\n        '
...
def get_stats():
    if not GITHUB_TOKEN:
        return "Errore: GITHUB_TOKEN mancante nel file .env", 500

    username = request.args.get("username")
    if not username:
        return "Errore: Username mancante nell'URL", 400
    ...
    <svg width="480" height="240" viewBox="0 0 480 240" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <g stroke="#cba6f7" stroke-width="0.5" opacity="0.15">
            <line x1="320" y1="40" x2="350" y2="25" />
            <line x1="350" y1="25" x2="370" y2="50" />
            <line x1="370" y1="50" x2="340" y2="70" />
        </g>
        ...
        <g transform="translate(35, 55)">
            <g class="stat-row" style="animation-delay:0.1s">
                ...
                <text x="25" y="0" class="text-title">{username}</text>
            </g>
        </g>
        ...
        <g transform="translate(415, 185) rotate(-15) scale(0.85)" fill="#f5e0dc">
            <path d="M-10,2 C-12,-4 -5,-9 0,-9 C5,-9 12,-4 10,2 C7,9 -7,9 -10,2 Z" />
            <ellipse cx="-12" cy="-10" rx="3.5" ry="5" transform="rotate(-30 -12 -10)" />
            <ellipse cx="-4" cy="-17" rx="3.5" ry="5" transform="rotate(-10 -4 -17)" />
            <ellipse cx="4" cy="-17" rx="3.5" ry="5" transform="rotate(10 4 -17)" />
